...
<section class="content">
	<div class="box box-primary">
		...
		<form id="frm_addproduk" class="form-horizontal">
			<div class="box-body">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<select name="jenis_attribute" id="jenis_attribute" class="form-control">
								...
								<option value="{{$attr->id}}">{{$attr->nama_attribute}}</option>
								@endforeach
							</select>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8">
							<textarea name="attribute" id="attribute" class="form-control"></textarea>
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="harga" id="harga" class="form-control" value="0">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="hargaakhir" id="hargaakhir" class="form-control" readonly="" value="0">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<div class="input-group">
								<input type="text" name="images" id="images" class="form-control" onchange="javascript:$('#images-preview').attr('src',$(this).val());">
								<span class="input-group-btn">
									<a id="images_browse" data-input="images" data-preview="images-preview" class="btn btn-primary">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<textarea name="simple_desc" id="simple_desc" class="form-control" maxlength="250"></textarea>
...
<script type="text/javascript">
	...
	function simpandataproduk() {
		...
		CKupdate();
		$.ajax({
			url : '{{URL::to("")}}/produk/insert',
			type : 'post',
			data : $('#frm_addproduk').serialize(),
			success : function(data) {
				if (data == 'berhasil') {
					toastr.success('Berhasil');
					$('#frm_addproduk')[0].reset();
				} else {
