...
<section class="content">
	<div class="box box-primary">
		...
		<form id="frm_adddatapage" class="form-horizontal">
			<div class="box-body">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" name="nama_page" id="nama_page" class="form-control">
						</div>
					</div>
...
var options = {
 ...
 CKEDITOR.replace('descript',options);
	function simpandatapage() {
		...
		CKupdate();
		$.ajax({
			url : '{{URL::to("")}}/page/insert',
			type : 'post',
			data : $('#frm_adddatapage').serialize(),
			success : function(data) {
				if (data == 'berhasil') {
					toastr.success('Berhasil');
					$('#frm_adddatapage')[0].reset();
				} else {
